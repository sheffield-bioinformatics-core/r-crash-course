...
```
The height of the bars can also be mapped directly to numeric variables in the data frame if the `geom_col` function is used insteam of `geom_bar`. Note that the axis labels can be modified, as we will see later on.
