...
We are going to use the `dplyr` package to manipulate the data frame we have just created. This is part of the `tidyverse` eco-system of packages that provide a consistent, intuitive system for data manipulation and visualisation in R.
...
- Create a subset of the data where the life expectancy is less than 45 in the year 2007
    + a subset of the data where the life expectancy is less than 45 in the year 2007 and the country is not in Africa

```{r}
filter(gapminder, lifeExp < 60, year == 2007)
