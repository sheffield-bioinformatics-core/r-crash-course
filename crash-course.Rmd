...
- One criticism of the boxplot is that it does not display the underlying data. Modify the boxplot showing GDP increase over time by adding points with `geom_point`.
